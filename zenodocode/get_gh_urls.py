...
class GhURLsGetter:
    ...
    def get_gh_urls(self, config_path='zenodococode/zenodoconfig.cfg', in_filename='zenodo_ids', read_in_location='data/', out_filename='gh_urls', write_out_location='data/', verbose=True):
        """
