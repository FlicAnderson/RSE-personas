...
def plot_repo_contributor_commits_stats(repo_data_df, repo_name, save_out=True, save_name='contributor_commits_totals_plot', save_type='png', save_out_location='images/', verbose=True):
    """
    ...
    if 'contributor_author' not in repo_data_df.columns:
        raise ValueError("Dataframe does not contain required column 'contributor_author'.")
