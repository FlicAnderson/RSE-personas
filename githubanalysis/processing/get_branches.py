...
class BranchesGetter: 
    ...
    def get_branches(self, repo_name, config_path='githubanalysis/config.cfg', per_pg=100):
        ...
        assert api_response.status_code != 401, f"WARNING! The API response code is 401: Unauthorised. Check your GitHub Personal Access Token is not expired. API Response for query {api_call} is {api_response}" 
